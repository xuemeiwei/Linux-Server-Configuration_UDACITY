...
You can visit http://52.33.81.20 for the website deployed.
...
4. In your terminal, type in
	```ssh -i ~/.ssh/udacity_key.rsa root@52.33.81.20```
...
4. now you can use ssh to login with the new user you created
	...
	`ssh -i [privateKeyFilename] grader@52.33.81.20`
...
2. Add the following lines of code to the file to configure the virtual host. 
	...
	```
	<VirtualHost *:80>
		ServerName 52.33.81.20
		ServerAdmin xuemeiwei1226@gmail.com
